...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.loginUserLineEdit.returnPressed.connect(self.loginPushButton.click)
        ...
        self.extractTabGetJobsPushButton.setGeometry(QtCore.QRect(437, 11, 131, 32))
        self.extractTabGetJobsPushButton.setAutoDefault(False)
        self.extractTabGetJobsPushButton.setObjectName("extractTabGetJobsPushButton")
        self.extractTabJobTableWidget = QtWidgets.QTableWidget(self.extractTab)
        self.extractTabJobTableWidget.setGeometry(QtCore.QRect(10, 50, 1171, 251))
        ...
        self.extractTabSearchJobLineEdit.setGeometry(QtCore.QRect(273, 15, 131, 21))
        ...
        self.extractTabSearchJobLineEdit.setObjectName("extractTabSearchJobLineEdit")
        ...
        self.extractTabSelectAllJobsPushButton = QtWidgets.QPushButton(
            self.extractTab, clicked=lambda: self.allTabsCheckBoxes("extractTab", True)
        )
        ...
        self.extractTabDeselectAllJobsPushButton = QtWidgets.QPushButton(
            self.extractTab, clicked=lambda: self.allTabsCheckBoxes("extractTab", False)
        )
        ...
        self.extractTabClearPushButton = QtWidgets.QPushButton(
            self.extractTab, clicked=lambda: self.allTabsTableWidgetClear("extractTab")
        )

        self.extractTabClearPushButton.setGeometry(QtCore.QRect(260, 310, 131, 32))
        self.extractTabClearPushButton.setObjectName("extractTabClearPushButton")
        ...
        self.extractTabJobSearchLabel.setGeometry(QtCore.QRect(210, 17, 51, 16))
        ...
        self.ownersTabContentTableWidget = QtWidgets.QTableWidget(self.ownersTab)
        self.ownersTabContentTableWidget.setGeometry(QtCore.QRect(10, 50, 1171, 251))
        self.ownersTabContentTableWidget.setObjectName("ownersTabContentTableWidget")
        ...
        self.ownersTabLoadOwnersPushButton.setGeometry(QtCore.QRect(7, 11, 121, 32))
        ...
        self.ownersTabSelectOwnerLabel.setGeometry(QtCore.QRect(124, 15, 101, 20))
        self.ownersTabSelectOwnerLabel.setAlignment(
            QtCore.Qt.AlignRight | QtCore.Qt.AlignTrailing | QtCore.Qt.AlignVCenter
        )
        self.ownersTabSelectOwnerLabel.setObjectName("ownersTabSelectOwnerLabel")
        self.ownersTabOwnersComboBox = QtWidgets.QComboBox(self.ownersTab)
        self.ownersTabOwnersComboBox.setGeometry(QtCore.QRect(235, 13, 161, 26))
        ...
        self.ownersTabGetContentPushButton.setGeometry(QtCore.QRect(437, 11, 131, 32))
        ...
        self.ownersTabSelectAllPushButton = QtWidgets.QPushButton(
            self.ownersTab, clicked=lambda: self.allTabsCheckBoxes("ownersTab", True)
        )

        self.ownersTabSelectAllPushButton.setGeometry(QtCore.QRect(10, 310, 121, 32))
        self.ownersTabSelectAllPushButton.setObjectName("ownersTabSelectAllPushButton")

        self.ownersTabDeselectAllPushButton = QtWidgets.QPushButton(
            self.ownersTab, clicked=lambda: self.allTabsCheckBoxes("ownersTab", False)
        )

        self.ownersTabDeselectAllPushButton.setGeometry(QtCore.QRect(130, 310, 131, 32))
        ...
        self.ownersTabClearPushButton = QtWidgets.QPushButton(
            self.ownersTab, clicked=lambda: self.allTabsTableWidgetClear("ownersTab")
        )

        self.ownersTabClearPushButton.setGeometry(QtCore.QRect(260, 310, 131, 32))
        ...
        self.ownersTabSelectNewOwnerLabel.setGeometry(QtCore.QRect(420, 314, 131, 20))
        self.ownersTabSelectNewOwnerLabel.setAlignment(
            QtCore.Qt.AlignRight | QtCore.Qt.AlignTrailing | QtCore.Qt.AlignVCenter
        )
        self.ownersTabSelectNewOwnerLabel.setObjectName("ownersTabSelectNewOwnerLabel")
        self.ownerTabNewOwnerComboBox = QtWidgets.QComboBox(self.ownersTab)
        self.ownerTabNewOwnerComboBox.setGeometry(QtCore.QRect(560, 312, 161, 26))
        ...
        self.ownersTabChangeOwnerPushButton.setGeometry(QtCore.QRect(730, 310, 151, 32))
        ...
        self.datasourcesTabDatasourceSearchLabel = QtWidgets.QLabel(self.datasourcesTab)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.datasourcesTabDatasourceTableWidget.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.datasourcesTabDatasourceTableWidget.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.datasourcesTabDatasourceTableWidget.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.datasourcesTabDatasourceTableWidget.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.datasourcesTabDatasourceTableWidget.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.datasourcesTabDatasourceTableWidget.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.datasourcesTabDatasourceTableWidget.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        self.datasourcesTabDatasourceTableWidget.setHorizontalHeaderItem(7, item)
        ...
        self.datasourcesTabClearPushButton.setGeometry(QtCore.QRect(260, 310, 131, 32))
        ...
        self.datasourcesTabExtractLabel.setGeometry(QtCore.QRect(420, 314, 131, 20))
        self.datasourcesTabExtractLabel.setAlignment(
            QtCore.Qt.AlignRight | QtCore.Qt.AlignTrailing | QtCore.Qt.AlignVCenter
        )
        self.datasourcesTabExtractLabel.setObjectName("datasourcesTabExtractLabel")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Tableau Server Tools"))
        self.loginGroupBox.setTitle(_translate("MainWindow", "Tableau Server Login"))
        self.loginEnvLabel.setText(_translate("MainWindow", "Environment:"))
        self.loginComboBox.setItemText(0, _translate("MainWindow", "Production"))
        ...
        self.extractTabGetJobsPushButton.setText(_translate("MainWindow", "Get Jobs"))
        ...
        self.extractTabJobComboBox.setItemText(0, _translate("MainWindow", "Open"))
        self.extractTabJobComboBox.setItemText(1, _translate("MainWindow", '"Pending"'))
        self.extractTabJobComboBox.setItemText(
            2, _translate("MainWindow", '"In Progress"')
        )
        self.extractTabJobComboBox.setItemText(3, _translate("MainWindow", "Search"))
        ...
        self.extractTabClearPushButton.setText(_translate("MainWindow", "Clear Table"))
        self.extractTabJobsLabel.setText(_translate("MainWindow", "Jobs:"))
        self.extractTabJobSearchLabel.setText(_translate("MainWindow", "Search:"))
        ...
        self.ownersTabClearPushButton.setText(_translate("MainWindow", "Clear Table"))
        ...
        self.datasourcesTabExtractLabel.setText(_translate("MainWindow", "Extract:"))
        self.toolsTabWidget.setTabText(
    ...
    def tableauServerGetJobs(self):
        ...
        # Make server request
        server_response = self.tableauServer.jobs.get_request(baseurl, req_option)
        # Parse job objects
    ...
    def extractTabTerminateJobsWarning(self):
        ...
        if len(self.extractTabTerminateJobsList) > 0:
            ...
            msg.setText("Are you sure you want to terminate the selected jobs?")
        ...
        if clickedButton.text() == "Cancel":
            ...
            for job in self.extractTabTerminateJobsList:
                try:
                    ...
                    try:
                        headers = {"X-Tableau-Auth": self.tableauServer.auth_token}
                        requests.put(
                            f"https://tableau.roktinternal.com/api/{self.tableauServer.version}/sites/{self.tableauServer.site_id}/jobs/{job[1]}",
                            headers=headers,
                        )
                    except Exception:
                        pass
                try:
                    status = self.tableauServer.jobs.get_by_id(job[1]).finish_code
                    if status == "2":
                        item = QtWidgets.QTableWidgetItem("Terminated")
                        item.setForeground(QtGui.QBrush(QtGui.QColor(185, 66, 38)))
                        ...
                        item.setForeground(QtGui.QBrush(QtGui.QColor(26, 127, 18)))
                        self.extractTabJobTableWidget.setItem(job[0], 3, item)
                except Exception:
                    pass
    ...
    def ownersTabGetContent(self):
        ...
        for resource in currentOwnerResources:
            ...
            self.ownersTabContentTableWidget.setItem(
                i, 7, QtWidgets.QTableWidgetItem(str(len(resource.connections)))
            )
            self.ownersTabContentTableWidget.setItem(
                i,
                8,
        ...
        if len(ownersTabChangedOwners) > 0:
            ...
            for indexResourceTypeConnections in ownersTabChangedOwners:
                ...
                if type == "Workbook":
                    ...
                    self.datasources[self.datasources.index(resource)] = resource
                    for connection in connections:
                        connectionInfo = (
                            connection.connection_type,
                            connection.server_address,
    ...
    def datasourcesTabSelectDirectory(self):
        ...
        if len(downloadDatasources) > 0:
            ...
            folder_path = dialog.getExistingDirectory(None, "Select Download Folder")
            if folder_path:
